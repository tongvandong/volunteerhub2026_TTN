...
namespace BaseCore.Repository.Migrations
{
    ...
    [Migration("20260606174845_ExpandAuthEventEntities")]
    partial class ExpandAuthEventEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseCore.Entities.Channel", b =>
                {
                    ...
                    b.HasIndex("EventId", "ParentChannelId");
            ...
            modelBuilder.Entity("BaseCore.Entities.Event", b =>
                {
                    ...
                    b.Property<decimal>("CheckInRadiusKm")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)")
            ...
            modelBuilder.Entity("BaseCore.Entities.KycSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseCore.Entities.Mention", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MentionerUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseCore.Entities.Poll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseCore.Entities.PollOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseCore.Entities.PollVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseCore.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BloodType = "O",
                            CreatedAt = new DateTime(2026, 6, 6, 17, 48, 44, 646, DateTimeKind.Utc).AddTicks(2473),
                            DonationCount = 0,
            ...
            modelBuilder.Entity("BaseCore.Entities.Channel", b =>
                {
                    ...
                    b.HasOne("BaseCore.Entities.Channel", "ParentChannel")
            ...
            modelBuilder.Entity("BaseCore.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BaseCore.Entities.Comment", "ParentComment")
                        .WithMany()
            ...
            modelBuilder.Entity("BaseCore.Entities.KycSubmission", b =>
                {
                    b.HasOne("BaseCore.Entities.VolunteerProfile", "VolunteerProfile")
            ...
            modelBuilder.Entity("BaseCore.Entities.Mention", b =>
                {
                    b.HasOne("BaseCore.Entities.User", "MentionedUser")
                        .WithMany()
                        .HasForeignKey("MentionedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BaseCore.Entities.User", "Mentioner")
                        .WithMany()
                        .HasForeignKey("MentionerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BaseCore.Entities.Poll", b =>
                {
                    b.HasOne("BaseCore.Entities.Post", "Post")
                        .WithOne("Poll")
                        .HasForeignKey("BaseCore.Entities.Poll", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BaseCore.Entities.PollOption", b =>
                {
                    b.HasOne("BaseCore.Entities.Poll", "Poll")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("BaseCore.Entities.PollVote", b =>
                {
                    b.HasOne("BaseCore.Entities.PollOption", "Option")
                        .WithMany()
            ...
            modelBuilder.Entity("BaseCore.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasOne("BaseCore.Entities.User", null)
                        ...
                        .HasForeignKey("BaseCore.Entities.VolunteerProfile", "UserId1");
