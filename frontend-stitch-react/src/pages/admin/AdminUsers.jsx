              ...
              <tbody className="divide-y divide-outline">
                {users.map((user) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-label-sm font-bold ${user.isActive === true ? "bg-success-container text-on-success-container" : "bg-error-container text-error"}`}
                      >
